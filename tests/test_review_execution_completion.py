...
def test_reviewer_prompts_require_full_contract_semantics():
    ...
    assert "never substitute" in INSPECTOR_SYSTEM_PROMPT
    assert "both a CODE" in INSPECTOR_SYSTEM_PROMPT
    ...
    assert "separate observation for each" in INSPECTOR_SYSTEM_PROMPT
